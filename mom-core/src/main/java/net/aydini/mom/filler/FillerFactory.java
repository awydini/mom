...
public class FillerFactory
{
    ...
    public static FieldFiller getFieldFiller(Field field , ObjectMaper objectMapper)
    {
        if(field.isAnnotationPresent(MapedField.class))
            return new AnnotatedFieldFiller(objectMapper);
        return new SimpleFieldFiller(objectMapper);
    }
